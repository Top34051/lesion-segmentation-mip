...
# name = "Dataset500_MIP_Segmentation_test"
name = "Dataset501_Synthetic_MIP_Segmentation_test"
...
def process_images(images):
    ...
    if os.path.exists(f"{output_dir}/{image_id}.nii.gz"):
        return
    original_suv_path = f"nnUNet_raw/Dataset600_PET_CT_Recon/imagesTs/{image_split[0]}_{image_split[1]}_{image_split[2]}_0000.nii.gz"
