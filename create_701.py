...
dir_path = "nnUNet_raw/Dataset701_PET_CT_Recon_Synthetic/"
...
def process_row(row, dir_path):
    ...
    if split == "train_val":
        ...
        recon_path = f"nnUNet_outputs_reconstructed/Dataset501_Synthetic_MIP_Segmentation_train/{subject_id}_{study_id}.nii.gz"
        ...
        recon_path = f"nnUNet_outputs_reconstructed/Dataset501_Synthetic_MIP_Segmentation_test/{subject_id}_{study_id}.nii.gz"
